...
<body>
    ...
    <div class="col-md-8">
        ...
        <!-- End Horizontal Form -->
        <?php if($_GET[ 'list']=='likes' ) { echo '<a class="btn btn-info" style="color:white;" href="?">Nach Reihenfolge sortieren!</a>';} else {echo '<a class="btn btn-info" style="color:white;" href="?list=likes">Nach Anzahl der Likes sortieren!</a>';} ?>
